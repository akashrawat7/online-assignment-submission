...
$query=mysqli_query($con," SELECT * FROM uplode where course like 'BCA%' ORDER BY id DESC ");
...
for ($i=1; $i <=$rowcount; $i++) { 
 ...
 ?>
		...
		<li> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>submit project:</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href='uplode/<?php echo $row['file'] ?>'><?php echo $row['file'] ?></a></li>
		<li></li>
	</ol></div>
 <hr>
